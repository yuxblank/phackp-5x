...
class ReflectionUtils
{
     ...
     * @return array
     */
    public static function getInstanceProperties($object) {
     ...
     * @return array
     */
    public static function getInstancePropertiesValues($object) {
    ...
    public static function invoke($object, $action) {
